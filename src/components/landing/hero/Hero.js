...
const Hero = (props) => {
  return (
    <div className="hero-section">
      ...
      />
      <a className="btn-test hide-mobile" style={{ cursor: 'pointer', zIndex: '999', right: 0, position: 'absolute', }} onClick={props.onTestItOutClick}>Test it out!</a>
      <div className="tagline">
        <p>
          Stlyed <br className="hide-desktop" />Sketch{" "}
          <br className="hide-mobile" />UI kits for quick prototyping!
        </p>
        <a style={{ cursor: 'pointer', zIndex: '999' }} onClick={props.onTestItOutClick} className="btn-test hide-desktop">
          Test it out!
        </a>
      </div>
      {/* Black circles */}
